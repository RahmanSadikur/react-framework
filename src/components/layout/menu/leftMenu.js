...
export const childMenulist = [
    ...
    { id: 3,parentMenuIndex: 3,component:Site,name:"site", title: 'Site',link:"/inventory/site",icon:"pi pi-chart-bar" ,isSelect:false,hasChild:false },
    { id: 4, parentMenuIndex: 3,component:Category,name:"category", title: 'Category',icon:"pi pi-chart-bar" ,link:"/inventory/category",isSelect:false,hasChild:false },
    { id: 5,parentMenuIndex: 3,component:SubCategory,name:"subCategory", title: 'Sub Category',icon:"pi pi-chart-bar" ,link:"/inventory/subcategory",isSelect:false,hasChild:false },
    { id: 6,parentMenuIndex: 3,component:Item,name:"item", title: 'Product',icon:"pi pi-chart-bar" ,link:"/inventory/item",isSelect:false,hasChild:false },
    { id: 7,parentMenuIndex: 3,component:ItemDetails,name:"itemdetails", title: 'Product Details',icon:"pi pi-chart-bar" ,link:"/inventory/itemdetails",isSelect:false,hasChild:false },
    { id: 8, parentMenuIndex: 2,component:UserType,name:"userType", title: 'User Type',icon:"pi pi-chart-bar" ,link:"/hr/usertype",isSelect:false,hasChild:false },
    { id: 9, parentMenuIndex: 2,component:User,name:"user", title: 'User',icon:"pi pi-chart-bar" ,link:"/hr/user",isSelect:false,hasChild:false },
    { id: 10, parentMenuIndex: 2,component:Payslip,name:"payslip", title: 'Payslip',icon:"pi pi-chart-bar" ,link:"/hr/payslip",isSelect:false,hasChild:false },
    { id: 11, parentMenuIndex: 6,component:Test,name:"Test", title: 'Test',icon:"pi pi-chart-bar" ,link:"/test",isSelect:false,hasChild:false },
